...
const Footer: React.FC<FooterProps> = () => {
  ...
  const mapEmbedUrl =
    'https://www.google.com/maps/embed/v1/place?q=Av.+Eduardo+Fróes+da+Mota,+5000+-+Campo+Limpo,+Feira+de+Santana+-+BA,+44032-002'
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-start">
          ...
          <div className="md:col-span-3 flex flex-col justify-center h-full">
            ...
            <div>
              ...
              <p className="text-base hover:text-senai-blue hover:underline cursor-pointer">
                {contacts.email}
              </p>
            </div>
          </div>
