...
const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <header className="bg-white w-full shadow-md"> {/* Adicionado sombra como na imagem */}
      <div className="container mx-auto px-6 py-3 flex justify-between items-center"> {/* Ajustado padding */}
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white px-6 pb-4">
          <nav className="flex flex-col space-y-2">
            <a href="#repositorio" className="text-gray-600 hover:text-senai-blue py-1">Repositório</a>
            <a href="#lab-maker" className="text-gray-600 hover:text-senai-blue py-1">Lab Maker</a>
            <a href="#biblioteca-maker" className="text-gray-600 hover:text-senai-blue py-1">Biblioteca Maker</a>
